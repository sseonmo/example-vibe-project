    ...
    <main>
      ...
      <header className="mb-10">
        ...
        <p className="mt-3 max-w-2xl text-[var(--color-muted)]">
          ...
          가장 넓은 범위(관리 정책)부터 가장 좁은 범위(로컬)까지, 안쪽이
          바깥쪽을 보강·재정의합니다.
        </p>
      </header>
      ...
      <section className="grid gap-5 md:grid-cols-2">
        <div className="surface p-6">
          ...
          <p className="text-sm text-[var(--color-muted)]">
            <code>CLAUDE.md</code>는{" "}
            <span className="text-[var(--color-fg)]">사람</span>이 쓰고, 자동
            메모리(memory tool)는{" "}
            <span className="text-[var(--color-fg)]">Claude</span>가 대화 중
            학습한 사실을 씁니다. 둘은 서로 보완하며, 같은 정보를 중복해서 넣지
            않는 게 핵심.
          </p>
        </div>
        <div className="surface p-6">
